...
public class NarratorGroup implements ImageGroup{
	...
	public List<PathNameNumber> getImagePathList() {
		...
		temp = new PathNameNumber(".\\CharaMaterials\\Woman\\", "BackHair", 0);
		tempList.add(temp);
		//2
		...
		temp = new PathNameNumber(".\\CharaMaterials\\Woman\\", "FaceBody", 0);
		tempList.add(temp);
		//5
		//public BodyPartQueue Eye;
		temp = new PathNameNumber(".\\CharaMaterials\\Woman\\", "Eye", 0);
		tempList.add(temp);
		//6
		//public BodyPartQueue Eyebow;
		temp = new PathNameNumber(".\\CharaMaterials\\Woman\\", "Eyebow", 0);
		tempList.add(temp);
		//7
		//public BodyPartQueue Mouth;
		temp = new PathNameNumber(".\\CharaMaterials\\Woman\\", "Mouth", 0);
		tempList.add(temp);
		...
		temp = new PathNameNumber(".\\CharaMaterials\\Woman\\", "FrontHair", 0);
		tempList.add(temp);
